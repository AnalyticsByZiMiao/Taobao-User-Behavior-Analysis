...
-- 平均访问深度：也称平均访问量，指用户每次访问页面的平均值，PV/UV
...
可见，在九天统计周期内，在这抽取的约一百万条数据里，淘宝的总访问量达到将近90万，访客数多达9700人左右，平均访问深度约为92，即一个人每次大概访问了92个页面，可见淘宝流量优势之巨大。
...
<img src="../images/25 小时为单位的UV PV趋势图.png" alt="以小时为单位的PV和PV" width="800" />
...
至此，运用MySQL分析了从淘宝平台从2017年11月25日到2017年12月03日约1亿条数据中抽样的约100W条用户行为数据，并运用tableau实现可视化。
从平台流量整体情况、用户行为习惯、用户商品偏好、用户行为转化路径、用户价值区分进行多角度分析，结合分析结果，给出如下建议：
...
2. 在一天中，用户活跃的黄金时段在19:00-22:00左右，该时段是流量巅峰时段，平台可加大力度在此时段进行流量变现或者是进行促销推销等活动。
